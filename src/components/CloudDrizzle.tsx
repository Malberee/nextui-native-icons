...
const SvgCloudDrizzle = (props: SvgProps) => (
  <Svg viewBox="0 0 24 24" width={24} height={24} fill="none" {...props}>
    ...
    <Path
      fill="currentColor"
      d="M13.47 14.39h-2.94c-1.27 0-2.03.76-2.03 2.03v2.94c0 1.27.76 2.03 2.03 2.03h2.94c1.27 0 2.03-.76 2.03-2.03v-2.94c0-1.27-.76-2.03-2.03-2.03m-1.76 4.45-1.24 1.23c-.09.09-.21.14-.32.14-.13 0-.24-.05-.33-.14a.459.459 0 0 1 0-.65l1.23-1.24a.47.47 0 0 1 .66 0c.18.18.18.48 0 .66m0-2.48-1.24 1.24c-.09.09-.21.14-.32.14a.47.47 0 0 1-.33-.8l1.23-1.23a.47.47 0 0 1 .66 0c.18.18.18.47 0 .65m2.47 2.48-1.23 1.23c-.1.09-.21.14-.33.14a.47.47 0 0 1-.33-.14.459.459 0 0 1 0-.65l1.24-1.24c.18-.18.47-.18.65 0 .18.18.18.48 0 .66m0-2.48-1.23 1.24c-.1.09-.21.14-.33.14a.47.47 0 0 1-.33-.8l1.24-1.23a.459.459 0 1 1 .65.65"
    />
  </Svg>
);
